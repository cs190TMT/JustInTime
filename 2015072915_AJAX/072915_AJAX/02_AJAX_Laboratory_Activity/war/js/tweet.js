...
$(document).ready(function() {
	...
	$(document).on('click', '#tweetList .btnDelete', function(){
		...
		var errorDisplay = $(this).parent().find('.updateErrorDisplay');//TODO: (optional) use jQuery traversals to get the correct updateErrorDisplay div.
		
		var idValue = $(this).parent().children('.id').val();//TODO: use jQuery traversals to get correct id value to be passed in json object.

		var contentValue = $(this).parent().children('.content').val();//TODO: use jQuery traversals to get correct content value to be passed in json object.
		
		var createdDateValue = $(this).parent().children('.createdDate').val();//TODO: use jQuery traversals to get correct createdDate value to be passed in json object.
	...
	$(document).on('click', '#tweetList .btnUpdate', function(){
		...
		var errorDisplay = $(this).parent().find('.updateErrorDisplay');
		
		var idValue = $(this).parent().children('.id').val();

		var contentValue = $(this).parent().children('.content').val();
		
		var createdDateValue = $(this).parent().children('.createdDate').val();
